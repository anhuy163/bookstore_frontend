...
export default function Category() {
  const dummyBookData = [
    ...
    },
    {
      ...
      value: 400000,
      cover:
        "https://m.media-amazon.com/images/I/41VsfjWEvSL._SX438_BO1,204,203,200_.jpg",
      intro:
    ...
    },
    {
      ...
      value: 120000,
      cover:
        "https://m.media-amazon.com/images/I/51kpoART0HL._SY424_BO1,204,203,200_.jpg",
      intro:
        "In this classic of childrens literature, beloved by generations of readers and listeners, the quiet poetry of the words and the gentle, lulling illustrations combine to make a perfect book for the end of the day.",
      brief:
    ...
    <div className={styles.categoryWrapper}>
      <Carousel
        ...
        <div className={styles.cardWrapper}>
          {dummyBookData.map((book, index) => (
            <BookCardWrapper key={index} data={book} />
          ))}
          {/* <BookCardWrapper />
          <BookCardWrapper />
          <BookCardWrapper />
